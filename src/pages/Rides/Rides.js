...
const myRides = [
  {
    ...
    Heading:
      'Sapphire Mall Internal Walkway, Orchid Petals, Block S, Uppal Southend, Sector 49, Gurugram, Haryana 122018, India',
    ...
    <div className="flex justify-center w-full h-full px-4 py-10 overflow-y-auto">
      ...
      <div className="w-[40rem]">
        ...
        <div className=" text-white my-3 flex justify-center">
          <NavLink to="/" className="w-max p-2 bg-black rounded-md">
            Reserve your ride
          </NavLink>
        </div>
        {myRides.map((mr) => (
          <div className="border-2 border-gray-400 rounded-2xl w-full h-72 my-6">
